...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fusedLocationClient.getLastLocation()
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        if (location != null) {
                            GlobalSettings.enlem=location.getLatitude();
                            GlobalSettings.boylam=location.getLongitude();
                        }
                    }
                });
        ...
        btnGirisYap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                   if(kullanicilar.get(i).getEmail().equals(username) && kullanicilar.get(i).getPassword().equals(password))
                   {
                       result=true;
                   }
                }
                ...
                {
                    Toast.makeText(LoginActivity.this,"Girilen bilgilere ait kullanıcı bulunamadı",Toast.LENGTH_LONG).show();
                }
            }
        });

        Button btnUyeOl=(Button)findViewById(R.id.btnUyeOl);
        btnUyeOl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(LoginActivity.this,UyeOlActivity.class);
                startActivity(intent);
            }
        });
    ...
    private String GetUsersJson()
    {
        ...
        String result="";
        try {
            url = new URL("https://dene-fe577.firebaseio.com/Kullanici.json?auth=wXfzHDOIFOnZpzsrm6Dpb40Wx9fP2hpDT31BU9lY");
